...
\makeindex
% makeindex expose.nlo -s nomencl.ist -o expose.nls
\makenomenclature
...
% --------------------------------------------------------------------------
\include{Inhalt/ExposeIntroduction}
\include{Inhalt/ExposeRelatedWork}
\include{Inhalt/ExposeMethodologyAndApproach}
\include{Inhalt/ExposeTimetable}



% \include{Inhalt/MethodologyAndApproach}
% \include{Inhalt/ScheduleAndState}
...
% \include{Inhalt/DeclarationOfOwnership}	% Selbständigkeitserklärung 
