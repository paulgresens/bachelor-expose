...
\begin{enumerate}
    ...
    \item Introduce a hierarchy of different cited text span extraction methods ranging from simple lexical and semantical matching up to complex reasoning capabilities, as well as strategic combinations of such, to allow for tradeoffs in accuracy and efficiency.
    \item Apply an automated framework to benchmark the retrieval and answering capabilities of non-parametric, retrieval- and evidence-based text generation systems on the proposed dataset as well as evaluating the extraction methods in terms of efficiency and correctness and quality of source attribution using NLI models and LLM-as-a-judge approaches.
\end{enumerate}
